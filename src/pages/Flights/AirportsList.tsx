          ...
          <table className="w-full text-left text-sm text-gray-600 whitespace-nowrap">
            <thead className="text-[11px] text-gray-500 uppercase bg-gray-50 border-b border-gray-100 font-semibold tracking-wider">
              <tr>
                ...
                <th className="px-6 py-4">IATA Code</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {airports.map((airport, index) => (
                <tr key={airport.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-3 font-medium text-gray-900">{airport.name}</td>
                  <td className="px-6 py-3">{airport.city}</td>
                  <td className="px-6 py-3">{airport.country}</td>
                  <td className="px-6 py-3">
